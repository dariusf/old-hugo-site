...
![first pretty-printed proof tree](/static/images/z3proof1.png)
...
![another proof tree](/static/images/z3proof2.png)

And here's another for the linear arithmetic formula $\exists x y. 2 x \leq 3 y, y > x, x > 0$.

![linear arithmetic formula proof, overwhelming detail](/static/images/z3proof3.png)
...
![theory lemma](/static/images/z3proof4.png)
...
[^1]: For a more formal and thorough introduction to satisfiability, check out [this blog post](https://homes.cs.washington.edu/~emina/blog/2017-06-23-a-primer-on-sat.html#satisfiability-and-validity).
